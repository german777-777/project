package by.itacademy.gpisarev.controllers.teacher.mark;
...
@Slf4j
@Controller
@RequestMapping("teacher/students/{studentID}/marks")
public class TeacherMarksController extends AbstractController {
    ...
    public TeacherMarksController(Map<String, MarkRepository> markRepositoryMap,
