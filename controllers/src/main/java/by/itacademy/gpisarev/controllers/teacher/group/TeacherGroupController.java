...
public class TeacherGroupController extends AbstractController {
    ...
    @Autowired
    public TeacherGroupController(Map<String, GroupRepository> groupRepositoryMap) {
    ...
    public ModelAndView get() {
        ModelAndView modelAndView = new ModelAndView("/teacher_groups");
