package by.itacademy.gpisarev.controllers.student.subject;
...
public class StudentSubjectController extends AbstractController {
    ...
    @Autowired
    public StudentSubjectController(Map<String, SubjectRepository> subjectRepositoryMap) {
    ...
    public ModelAndView getAllSubjects() {
        ModelAndView modelAndView = new ModelAndView("/student_subjects");
