...
@Slf4j
@Controller
@RequestMapping("teacher/groups/{groupID}/students")
public class TeacherGroupStudentController extends AbstractController {
    ...
    @Autowired
    public TeacherGroupStudentController(Map<String, GroupRepository> groupRepositoryMap,
