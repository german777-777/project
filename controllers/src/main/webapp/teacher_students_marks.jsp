...
<table border="1" width="100%">
    ...
    <c:forEach var="mark" items="${student.marks}">
        <tr style="text-align: center">
            ...
            <td>
                <form action="<c:url value="/teacher/students/${student.id}/marks/${mark.id}/put"/>" method="post">
...
<form action="<c:url value="/teacher/students/${student.id}/marks/post"/>" method="post">
    <label>
        Новая оценка:
        <input style="text-align: center; display: block" type="text" name="newMark">
    </label>
