...
<html>
<head>
    <title>Страница групп для Студента</title>
</head>
<body>
...
<table border="1" width="100%">
    ...
    <c:forEach var="group" items="${allGroups}">
        <tr style="text-align: center">
            ...
            <td>
                <form action="<c:url value="/student/groups/${group.id}/subjects"/>" method="get">
                    <button style="align-content: center; display: block" type="submit">Предметы</button>
                </form>
            </td>
            <td>
                <form action="<c:url value="/student/groups/${group.id}/students"/>" method="get">
